...
C                              THE IBM SYSTEM
C        OCT.   2012   GHIRARDELLI  MODIFIED FORMAT STATEMENT
...
C           DIRECTION.
C 
D        WRITE(KFILDO,131)IX,JY,GRAD,TGRAD,P(IX,JY)
D131     FORMAT(/' NO SMOOTHING IN X DIRECTION--',
D    1           'IX,JY,GRAD,TGRAD,P(IX,JY)',2I5,3F10.3)
         FD2(IX,JY)=0.
...
C           DIRECTION.
C      
D        WRITE(KFILDO,136)IX,JY,GRAD,TGRAD,P(IX,JY)
D136     FORMAT(/' NO SMOOTHING IN Y DIRECTION--',
D    1           'IX,JY,GRAD,TGRAD,P(IX,JY)',2I5,3F10.3)
         FD2(IX,JY)=0.
C           SETTING FD2( , ) = 0 MEANS THIS POINT WILL NOT BE SMOOTHED.
C
...
C      
      IF(ENDVAL.EQ.9999999.)THEN
D        WRITE(KFILDO,143)NX,NY,IX,JY
D143     FORMAT(/' CANNOT PROCESS CORNER POINT AT 143.'
D    1           '  NX =',I5,'    NY =',I5,
D    2           '  PROCESSING POINT IX,JY =',2I5)
         GO TO 152
      ENDIF
C
      RANGE=ENDVAL-P(IX,JY)
...
C           DIRECTION.
C      
D        WRITE(KFILDO,146)IX,JY,GRAD,TGRAD,P(IX,JY)
D146     FORMAT(/' NO SMOOTHING IN DIAGONAL LL TO UR DIRECTION--',
D    1           'IX,JY,GRAD,TGRAD,P(IX,JY)',2I5,3F10.3)
         FD2(IX,JY)=0.
C           SETTING FD2( , ) = 0 MEANS THIS POINT WILL NOT BE SMOOTHED.
C
...
C      
      IF(ENDVAL.EQ.9999999.)THEN
D        WRITE(KFILDO,153)NX,NY,IX,JY
D153     FORMAT(/' CANNOT PROCESS CORNER POINT AT 153.'
D    1           '  NX =',I5,'    NY =',I5,
D    2           '  PROCESSING POINT IX,JY =',2I5)
         GO TO 199
      ENDIF
...
C           DIRECTION.
C      
D        WRITE(KFILDO,156)IX,JY,GRAD,TGRAD,P(IX,JY)
D156     FORMAT(/' NO SMOOTHING IN DIAGONAL UL TO LR DIRECTION--',
D    1           'IX,JY,GRAD,TGRAD,P(IX,JY)',2I5,3F10.3)
         FD2(IX,JY)=0.
C           SETTING FD2( , ) = 0 MEANS THIS POINT WILL NOT BE SMOOTHED.
C
...
C
 ...
 275  CONTINUE
C
D     TITLE(17:24)='Q-GRID  '
D     CALL PRTGR(IP22,FD2,NX,NY,
D    1           2.,0.,1.,0.,IOPT,TITLE,IER)
C
 280  RETURN
      END
