...
C           AUG 2007   BAKER                  ADDED CAPABILITY TO COMPUTE
C                                             LAPSE RATE FOR THE NAM MODEL
C                                             BY ALLOWING ID FOR THE MSLP
C                                             DERIVED FROM MESINGER REDUCTION
C                                             PROCEDURE.
C              
C        PURPOSE
...
C
      ...
      ISTAV=0
C        
C        FOR NAM MODEL (DD=07), MSLP IS DERIVED VIA THE MESINGER
C        REDUCTION PROCEDURE.  ICCCFFF(3) IS SET TO 001210 TO
C        ACCOMODATE THIS.
C
