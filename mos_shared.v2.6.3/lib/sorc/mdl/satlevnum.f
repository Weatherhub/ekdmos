...
C                                SPECIFIC AND MPROJ=5 (NPS) TO FETCH FOR
C                                TERRAIN ID 409400.
C
...
C                 003 344 - ECMWF      ( 5 LEVEL), THRESHOLD 85 PERCENT
...
C                 003 354 - ECMWF      ( 5 LEVEL), THRESHOLD 90 PERCENT
...
C                 003 364 - ECMWF      ( 5 LEVEL), THRESHOLD 95 PERCENT
C
...
C
 ...
 148      FORMAT(/' ****NDATE, ',I10,', FOR ECMWF SATLEVNUM MUST',
     &             ' BE A MULTIPLE OF 3.')
          IER=187
          GO TO 800
        ENDIF
