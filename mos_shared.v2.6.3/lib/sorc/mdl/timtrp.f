...
C             EARLIER THAN PROJECTION 12.
C
            IF(((ID(1)/1000).EQ.203220).AND.(IDPARS(12).LT.12))GOTO 210
C
...
C
     ...
     2      ((ID(1)/1000.EQ.203220).AND.
     3       (IDPARS(12).LT.12)))THEN
C
C              208051 IS CEILING; 208351 IS TOTAL CLOUD AMOUNT.
C              203220 IS 6HR MOS QPF.
C
C              THIS IS A CATEGORICAL FORECAST.  TAKE THE NEAREST HOUR.
C              (IT IS RECOGNIZED ONE MORE CALL TO GFETCH IS MADE IN
