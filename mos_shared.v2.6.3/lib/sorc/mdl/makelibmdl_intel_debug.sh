...
#
export LIB="libmdl_4_debug.a"
#export FFLAGS=" -O3 -qfixed -qnosave -qintlog \
#-qintsize=4 -qrealsize=4 -qstrict"
export FFLAGS=" -g -traceback -nofree -integer-size 32 -real-size 32 -auto -fpscomp logicals -fp-model strict -assume byterecl"
make -f make.libmdl

#
#     Update 8-byte version of libmdl_8.a
#
export LIB="libmdl_8_debug.a"
##export FFLAGS=" -O3 -qfixed -qnosave -qintlog \
##-qintsize=8 -qrealsize=8 -qstrict"
export FFLAGS=" -g -traceback -nofree -integer-size 64 -real-size 64 -auto -fpscomp logicals -fp-model strict -assume byterecl"
make -f make.libmdl
#
rm -f make.libmdl
