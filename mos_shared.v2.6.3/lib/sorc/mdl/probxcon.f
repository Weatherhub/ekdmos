...
C                                      SNOW AMOUNTS.
C        OCTOBER   2008   MALONEY      ADDED NEW IDS FOR UNCONDITIONAL
C                                      SVR 6-H USING CONS.CHK. PROBS.
C                                      ADDED NEW IDS FOR UNCONDITIONAL
C                                      SVR 3-H AS WELL.
C
C        PURPOSE:
...
C                          207170       207165 * 207120 -- UNCOND  3-H SVR
C                          207270       207265 * 207220 -- UNCOND  6-H SVR
C                          207280       207275 * 207230 -- UNCOND  6-H SVR
...
C     
     ...
     3            207170,207165,207120,950000,
     4            207270,207265,207220,950000,
     5            207280,207275,207230,950000,
     6            207380,207375,207330,950000,
     7            207480,207475,207430,950000,
     8            208460,208465,203450,950052,
     9            208455,208445,208525,500051/
C
      IER=0
      ISTAB=1
C      
