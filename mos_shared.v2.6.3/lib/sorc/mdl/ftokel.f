      SUBROUTINE FTOKEL(KFILDO,KFIL10,IP12,KFILRA,RACESS,NUMRA,
     1                  ID,IDPARS,JD,ITAU,
...
C
C        PURPOSE 
C            TO CHANGE UNITS FROM FAHRENHEIT TO KELVIN.
C            CONVERSION USED:  C=(F-32)*5/9 + 273.15.  
...
C
 ...
 107  FORMAT(/,' ****FTOKEL ENTERED FOR VARIABLE',
...
C
  ...
  125    FORMAT(/,' ****VARIABLE NOT RETRIEVED BY RETVEC IN FTOKEL',
     1          2X,I9.9,1X,I9.9,1X,I9.9,1X,I10.3)
         GO TO 300
      ENDIF
C
