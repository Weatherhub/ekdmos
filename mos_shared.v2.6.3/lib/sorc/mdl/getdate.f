      SUBROUTINE GETDATE(IUNIT,IYR,IMO,IDA,IHR,NDATE,IERR)        
C                                                               
...
C                                                        
C        PURPOSE                                        
C           TO READ DATE-TIME GROUP FROM NMC'S STANDARD
C           DATE FILE AND RETURN IT TO CALLING PROGRAM IN TWO FORMATS. 
C                                                     
C        DATA SET USE                                
C            FTXX - NMC'S STANDARD DATE FILE (XX=01-99) (INPUT)
C                                                   
C        VARIABLES                                 
...
C                                          
      IERR=0                                
C                                            
C        READ NMC'S STANDARD DATE FILE        
C                                              
