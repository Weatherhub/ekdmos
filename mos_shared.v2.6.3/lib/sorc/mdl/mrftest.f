...
C                       202145   202105, 202205   IF BEYOND 282 HRS)
C                       202240   202220, 202120  (OR 202200, 202100
C                       202245   202205, 202105   IF BEYOND 282 HRS)
C
C        DATA SET USE 
...
C
      IF((JJ.EQ.1.OR.JJ.EQ.3).AND.IDPARS(12).GT.282)
     +   LD(1)=LD(1)-20000
C
...
C        MAKE CHANGES TO LD(1) IF BEYOND 282 HRS
C
      IF((JJ.EQ.1.OR.JJ.EQ.3).AND.IDPARS(12)-12.GT.282)
     +   LD(1)=LD(1)-20000
C
