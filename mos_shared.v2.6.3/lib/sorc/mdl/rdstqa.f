...
C
C            NOTE:  THE DIFFERENCE BETWEEN THIS RDSTQA AND RDSTQN IS 
...
C
      ...
      DATA BLANK/' '/
C
D     CALL TIMPR(KFILDO,KFILDO,'START RDSTQA        ')
C
      IER=0
      NSTX=0
      JSTA=0
...
C
 ...
 124  FORMAT(/,' ****ERROR READING STATION DIRECTORY IN RDSTQA.',
     1         '  IOSTAT =',I5)
      IER=33
...
C
      ENDIF
C
D     CALL TIMPR(KFILDO,KFILDO,'END RDSTQA          ')
C
 160  RETURN
      END
