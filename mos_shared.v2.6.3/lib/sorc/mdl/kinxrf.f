      SUBROUTINE KINXRF(KFILDO,KFIL10,IP12,IP16,IDPARS,JD,NDATE,
...
C        APRIL     2005   TRIMARCO  CHANGED RELATIVE FREQUENCY IDS TO 
C                                 ACCOUNT FOR A NEW ID STRUCTURE
C        JULY      2005   HUGHES  REMOVED PRINT STATEMENTS LEFT FROM TESTING
C
C        PURPOSE 
...
C
C                007 461 - KINDEX * PREVIOUS 3 HR THUNDERSTORMS
C                007 466 - KINDEX * SUBSEQUENT 3 HR THUNDERSTORMS
C                007 471 - KINDEX * PREVIOUS 6 HR THUNDERSTORMS
C                007 476 - KINDEX * SUBSEQUENT 6 HR THUNDERSTORMS
C                007 481 - KINDEX * PREVIOUS 12 HR THUNDERSTORMS
C                007 486 - KINDEX * SUBSEQUENT 12 HR THUNDERSTORMS
C                007 491 - KINDEX * PREVIOUS 24 HR THUNDERSTORMS
C
C        DATA SET USE
...
C        007461 = KINDEX * PREVIOUS 3 HR THUNDERSTORMS
C        007466 = KINDEX * SUBSEQUENT 3 HR THUNDERSTORMS
C        007471 = KINDEX * PREVIOUS 6 HR THUNDERSTORMS
C        007476 = KINDEX * SUBSEQUENT 6 HR THUNDERSTORMS
C        007481 = KINDEX * PREVIOUS 12 HR THUNDERSTORMS
C        007486 = KINDEX * SUBSEQUENT 12 HR THUNDERSTORMS
C        007491 = KINDEX * PREVIOUS 24 HR THUNDERSTORMS
C
      IF((IDPARS(1).NE.007).OR.((IDPARS(2).NE.461).AND.
     1 (IDPARS(2).NE.466).AND.(IDPARS(2).NE.471).AND.
     2 (IDPARS(2).NE.476).AND.(IDPARS(2).NE.481).AND.
     3 (IDPARS(2).NE.486).AND.(IDPARS(2).NE.491))) THEN
         IER=103
...
C       3 HRS PREVIOUS
C
      IF(IDPARS(2).EQ.461) THEN 
        LD(1)=437342000
        LD(3)=IDPARS(12)
C
C       3 HRS SUBSEQUENT
C
      ELSE IF(IDPARS(2).EQ.466) THEN
        LD(1)=437342000
        LD(3)=IDPARS(12)+3
C
C       6 HRS PREVIOUS
C
      ELSE IF(IDPARS(2).EQ.471) THEN
        LD(1)=437343000
        LD(3)=IDPARS(12)
C
C       6 HRS SUBSEQUENT
C
      ELSE IF(IDPARS(2).EQ.476) THEN
        LD(1)=437343000
        LD(3)=IDPARS(12)+6
C
C       12 HRS PREVIOUS
C
      ELSE IF(IDPARS(2).EQ.481) THEN 
        LD(1)=437344000
        LD(3)=IDPARS(12)
C
C       12 HRS SUBSEQUENT
C        
      ELSE IF(IDPARS(2).EQ.486) THEN 
        LD(1)=437344000
        LD(3)=IDPARS(12)+12
C
C       24 HRS PREVIOUS
C
      ELSE IF(IDPARS(2).EQ.491) THEN
        LD(1)=437345000
        LD(3)=IDPARS(12)
      ENDIF
C
