      SUBROUTINE L2D601000(KFILDO,KFIL10,NFIRST,
...
C        OCTOBER   1996   GLAHN   CHANGED ID FROM 400100 TO 601000
...
C 
C        PURPOSE 
C            TO TRANSFORM A PAIR OF PREDICTORS INTO CCCFFF = 601000
...
C                       ITS MAX VALUE OF L2DCMB.  (INTERNAL)
...
C
      ...
      DATA NDEF /1/
C
C     CALL TIMPR(KFILDO,KFILDO,'START L2D601000     ')
C
      IER=0
C
