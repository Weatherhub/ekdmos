...
C        JUNE     2007   GLAHN   CHANGED F8.3 TO F9.3 AT 200
C
C        PURPOSE
...
C
D     WRITE(KFILDO,200)XI,YJ,XMESHL,ORIENT,XLAT,
D    1                 XLATLL,XLONLL,ALAT,ALON
D200  FORMAT(/' IN PSIJLL--XI,YJ,XMESHL,ORIENT,XLAT,',
D    1        'XLATLL,XLONLL,ALAT,ALON',2F6.0,7F9.3)
      RETURN
      END
