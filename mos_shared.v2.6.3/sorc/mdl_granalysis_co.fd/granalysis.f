...
C
C MAIN PROGRAM: GRANLYSIS
C   PRGMMR: WAGNER          ORG: W/OST22       DATE: 09-09-18
C
...
C           THE USER OF U155 MIGHT HAVE TO CHANGE.  THIS VERSION
C           WAS MADE WITH SETTINGS LARGE ENOUGH TO ACCOMODATE BOTH
C           THE CONUS (AT 5KM AND 2.5KM) AND ALASKA, FOR BOTH GMOS
C           AND GRIDDED EKDMOS.
C 
...
C        NOVEMBER  2013   HUNTEMANN  INCREASED MAXSTA FROM 12000 TO
C                                 25000. THIS IS NEEDED TO RUN
C                                 GRANALYSIS ON THUNDERSTORMS FOR
C                                 2.5 KM CONUS 
C        FEBRUARY  2015   SCALLION   CHANGED ND13 TO BE ND1*100.     
C            JUNE  2015   SCALLION   CHANGED ND3 TO COVER THE
C                                 NORTHERN EXPANSION FOR THE
C                                 2.5KM CONUS.
C
C USAGE:
C
...
C
      PARAMETER (MAXSTA=25000)
C        ABOVE FOR CONUS TSTM
C      PARAMETER (MAXSTA=12000)
C        ABOVE FOR CONUS MAX/MIN TEMP
C
      PARAMETER (ND1=MAX(NBLOCK,MAXSTA))
CCC      PARAMETER (ND2=1321,
CCC     1           ND3=721)
CCCC        ABOVE FOR ALASKA 3-KM.
C
C    PARAMETER (ND2=1073,
C    1           ND3=689)
C        ABOVE FOR CONUS NDFD GRID 5 KM.
C
      PARAMETER (ND2=2145,
     1           ND3=1597)
...
C
     ...
     1     KFILDO/6/
      ...
      DATA LKHERE/ND6*1/
C
      CALL W3TAGB('GRANALYSIS',2009,0001,0002,'OST22')
