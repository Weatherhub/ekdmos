...
C
      WRITE(KFILDO,*)'BEFORE CALL TO RDSNAM, KFILP = ',KFILP
      CALL RDSNAM(KFILDI,KFILDO,KFILP,PRENAM,IDUM,IDUM,1,
     1            N,'OLD','FORMATTED',IP,IER)
      WRITE(KFILDO,*)'AFTER CALL TO RDSNAM, KFILP = ',KFILP
      IF(IER.NE.0)ISTOP(1)=ISTOP(1)+1
C
      IF(KFILP.EQ.0)THEN
         WRITE(KFILDO,1460)
...
C 
      WRITE(KFILDO,*)'BEFORE CALL TO RDPRED, KFILP = ',KFILP
      WRITE(KFILDO,*)'BEFORE CALL TO RDPRED, NPRED = ',NPRED
      IF(KFILP.NE.0) THEN
         WRITE(KFILDO,*)'...CALLING RDPRED...'
     ...
     2               ORIGIN,CINT,PLAIN,UNITS,ND4,NPRED,ISTOP(1),IER)
      WRITE(KFILDO,*)'AFTER CALL TO RDPRED, KFILP = ',KFILP
      WRITE(KFILDO,*)'AFTER CALL TO RDPRED, NPRED = ',NPRED
