...
C                                 ARE NOW IN ASCII
C       COSGROVE   NOV 2004     - COPIED THIS ROUTINE FROM TDLLIB AND
C                                 MADE A SPECIAL FECN21 VERSION THAT
C                                 ALLOWS FOR A 1280*11 BYTE MESSAGE.
...
C        FUNCTIONS:
C                CHAR=INTRINSIC FUNCTION WHICH RETURNS THE ASCII CHARACTER
...
C            BULLETIN.                                              
C          ***  AS OF 2004, THE LIMIT IS NOW 15,000 BYTES    
C                                                                       
