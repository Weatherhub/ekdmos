...
CCCC      DATA KUNIT/12/,JUNIT/27/,IUNIT/10/,NOUT/65/,NUNIT/60/,NHI/0/
     ...
     *           'AUG ','SEPT','OCT ','NOV ','DEC '/ 
      ...
      DATA MM/202120001,202220001,202120001,202220001,202120001,
     *        202120001,202220001,202120001,202220001,202120001,
     *        202220001,202120001,202220001,202120001,202220001,
     *        202220001,202120001,202220001,202120001,202220001/
...
C        HOUR PROJECTIONS ARE 24,36,48,60,72                         
      ...
      CALL W3TAGB('MDL_GFSMAVTX',2002,0011,0016,'OST22')
      ND5=MAXSTA
...
C
      ...
      CALL PUTCHAR('ECM MOS GUIDANCE',MSG(9,(K-1)*LINE+2),16)
...
C      CALL PUTCHAR('ECMWF MOS GUIDANCE',MSG(9,(K-1)*LINE+2),18)
...
C      CALL PUTMOS('MHG',FLOAT(MHG),0.,1.,0,18,MSG(40,(K-1)*LINE+2),
C     *       2,2,'99',KX)
C      KOUNT(1,K)=1     
C
