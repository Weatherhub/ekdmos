...
C                     OVER ALASKA.
C   08-04-07  SMB     INCREASED MAXGRD FROM 2800000 TO 4422528 TO
C                     HANDLE NMM 5KM TERRAIN.
C   09-12-02  JCM     INCREASED ND4 TO 13000.
C   13-11-08  TLH     INCREASED MAXSTA TO 2800000 FOR 2.5 KM GMOS.
C   15-02-12  TLH     INCREASED ND4 AND ND9 TO 17500
C                                                                       
C USAGE:                                                                
C                                                                       
C        DATA SET USE                                                   
...
C
      ...
      PARAMETER (MAXSTA=2800000)
      PARAMETER (ND1=MAX(NBLOCK,MAXSTA))
C***  set maxgrd for gtopo 5 km grid
C***  PARAMETER (MAXGRD=2800000) 
C***  set maxgrd for NMM 5 km grid
      PARAMETER (MAXGRD=4422528) 
