...
C            LDDST(4) = THE 4 IDS FOR OCEAN-TO-LAND DISTANCE.  SET BY 
C                       DATA STATEMENT.
...
CD        WRITE(KFILDO,146)NDATE
CD146     FORMAT(' AT 146 IN U155--NDATE',I11)
         GO TO 149
      ENDIF
C
 147  CONTINUE      
...
C
     ...
     8              FD1,FD2,FD3,FD4,FD5,FD6,FD7,FD8,FD9,ND2X3,
     9              ID,IDPARS,JD,JP,ICOMPT,ISCALD,
     A              THRESH,ANLTAB,INLTAB,IWRITS,IWRITA,DIR,NGRIDC,ND11,
     B              IPLAIN,PLAIN,ND4,PLAINT,IPLANT,NPRED,N,
