...
C                                 4-KM ETA
C        SEPTEMBER 2007   GLAHN   MINOR CHANGE
C        MARCH     2008   GLAHN   SPELL CHECK
...
C
      IF(NPROJ.EQ.5.AND.MESH.EQ.4)THEN
         XMESHN=4.
         XMESH=4.762
         GO TO 165
...
CD170  FORMAT(' DONE IN ACTUAL--XMESH,XMESHN,MESH',2F16.10,I6)
      RETURN
      END
