...
C                                 ON THE IBM SP
C        MAY       2000   GLAHN   MODIFIED COMMENTS CONCERNING IPACK,
C                                 IWORK
...
C        APRIL     2003   GLAHN   INSERTED COMMON BLOCK FETCH
C        MAY       2003   GLAHN   MODIFIED COMMENT ABOUT COMMON BLOCK
C        JUNE      2003   GLAHN   REMOVED INITIALIZATION OF IENTER
C        APRIL     2004   GLAHN   ADDED /D DIAGNOSTIC AT 165, 166
C        AUGUST    2004   GLAHN   ADDED NDX TO DIAGNOSTIC PRINT AT 107
C        SEPTEMBER 2004   GLAHN   ADDED NSLAB = 0 WHEN NO DATA RETURNED
C        SEPTEMBER 2004   GLAHN   MODIFIED FORMAT 107
C 
C        PURPOSE 
...
C            ARE RETURNED IN DATA( ) UNPACKED, WHETHER THEY ARE STORED 
...
C
C            A COMMON BLOCK FETCH MAINTAINS CONTACT BETWEEN GFETCH,
C            GFETCH1, GFETCH2, AND GFETCH3.
C
C        DATA SET USE 
...
C                       IS IMPERVIOUS TO ACTIONS BY THE USER.  (COMMON)
...
C
 106  CONTINUE
CD     WRITE(KFILDO,107)(JD(J),J=1,4),LDATE,NDX
CD107  FORMAT(/,' IN GFETCH,',26X,' LOOKING FOR',2X,I9.9,2I10.9,I11.3,
CD    1        '  FOR DATE',I11,'  NDX =',I8)   
C
...
C        SUBROUTINE UNPACK WILL NOT OVERFLOW DATA.
C
CCCD     WRITE(KFILDO,155)(IS1(JJ),JJ=1,22)
CCCD155  FORMAT(/' IN GFETCH AT 155--IS1( )'/(10I12))
CCCD     WRITE(KFILDO,156)(IS2(JJ),JJ=1,9)
CCCD156  FORMAT(/' IN GFETCH AT 156--IS2( )'/(9I12))
C
      IF(IER.NE.0)GO TO 180
C        IER NE 0 SHOULD BE TREATED AS A FATAL ERROR.  A DIAGNOSTIC
C        WILL HAVE BEEN PRINTED BY UNPACK.
...
C        THE FOLLOWING STATEMENTS ARE USED FOR INITIALIZING LSTORE(11, )
     ...
     1      LSTORE(11,J).EQ.0)LSTORE(11,J)=LSTORE(11,J)+LOCPRD
      ...
      ENDIF
C
C***D     WRITE(KFILDO,164)NFETCH,LOCPRD,(LSTORE(L,J),L=1,12)
C***D164  FORMAT(/' GFETCH  '2I4,I11.9,2I10.9,I10.3,I8,I8,I2,I11,2I4,I5,I10) 
C***D     WRITE(KFILDO,165)(IS1(JJ),JJ=1,22)
C***D165  FORMAT(/' IN GFETCH AT 165--IS1( )'/(10I12))
C***D     WRITE(KFILDO,166)(IS2(JJ),JJ=1,9)
C***D166  FORMAT(/' IN GFETCH AT 166--IS2( )'/(9I12))
      GO TO 200
C
 170  CONTINUE
C
...
C        SET NWORDS = 0 WHEN NO DATA RETURNED.
      NSLAB=0
C        SET NSLAB = 0 WHEN NO DATA RETURNED.
CD     WRITE(KFILDO,175)(JD(J),J=1,4),LDATE,IER
CD175  FORMAT(' ****DATA NOT FOUND BY GFETCH.',
CD    1       '        LOOKING FOR',2X,I9.9,2I10.9,I11.3,
CD    2       '  FOR DATE',I11,'  IER =',I5)
      GO TO 180
C
...
C
C***D     IF(LITEMS.LT.10)
C***D    1    WRITE(KFILDO,201)NFETCH,((LSTORE(L,J),L=1,12),J=1,LITEMS)
C***D201  FORMAT(/' GFETCH  ',I4,I11.9,2I10.9,I10.3,I8,I8,I2,I11,2I4,I5,I11/
C***D    1      ('             ',I11.9,2I10.9,I10.3,I8,I8,I2,I11,2I4,I5,I11)) 
C***D     WRITE(KFILDO,202)(LSTORE(M,J),M=1,12)
C***D202  FORMAT(/' GFETCH AT 202  ',3I10.9,I10.3,I8,I8,I2,I11,2I4,I5,I11) 
C
      RETURN
      END   
