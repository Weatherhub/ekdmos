...
C       NOV        2011    PS     ADDED IDS TO GRDUNTCVT FOR UNCOND. PTYPE AND
C                                 PTYPE BEST CATEGORY.
C       OCT        2013    PS     ADDED ID TO GRDUNTCVT FOR POPO
C
C       MAY        2015    MNB    ADDED CALL TO TIMTRPGOE AND CHANGED
C                                 "IDPARS(12).GT.180" TO "IDPARS(12).GT.240"
C                                 SINCE 3-HR GFS IS NOW AVAILABLE TO 240
C                                 HRS.
C 
C        PURPOSE 
...
C
     ...
     1       IDPARS(12).GT.240.AND.MOD(IDPARS(12),12).NE.0)THEN
...
C
     ...
     I                               (IDPARS(2).EQ.549).OR.
     J                               (IDPARS(2).EQ.547).OR.
     K                               (IDPARS(2).EQ.544).OR.
     L                               (IDPARS(2).EQ.624))))THEN
