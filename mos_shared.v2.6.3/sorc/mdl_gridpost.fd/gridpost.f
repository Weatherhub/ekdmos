...
C   08-03-27  RLC     INCREASED ND2 AND ND3 TO COVER THE AK GMOS GRID
C                     THAT COMES OUT OF U155.
C 2010-01-20  JCM     INCREASED MAXSTA FROM 11000 TO 12000 FOR EXPANDED
C                     CONUS GRID.
C 2010-03-31  FAN     INCREASED ND2, ND3 TO HANDLE 2.5KM CONUS GMOS
C 2015-05-28  MNB     INCREASED ND9 TO 10000
C 2015-05-29  SDS     INCREASED ND3 FOR THE EXPANDED 2.5KM CONUS GRID.
C   
C        DATA SET USE
C        INPUT FILES:
...
C
     ...
     1           ND3=1597)
      ...
      PARAMETER (ND5=ND2X3)
CTEST      PARAMETER (ND5=ND2X3+(ND2X3/2))
C
