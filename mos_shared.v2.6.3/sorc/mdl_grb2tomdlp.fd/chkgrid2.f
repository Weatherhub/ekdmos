...
C    APRIL      2014   ENGLE    ADDED CHECKS TO BASICALLY IGNORE THE
C                               ORIENTATION LONGITUDE WHEN THE GRID IS
C                               MERCATOR.
C     
...
C  
      IF(JALON.LT.0) THEN
         WRITE(KFILDO,110) 
 110     FORMAT(/,' ****THE LOWER LEFT LONGITUDE',
     1            ' IN THE GRID LIST FILE',
     ...
     3            ' BE POSITIVE WEST.  STOP 110 IN CHKGRID2.')
      ...
      ENDIF
C
      IF(JORIENT.LT.0.AND.JMAP.NE.7) THEN
         WRITE(KFILDO,111) 
 111     FORMAT(/,' ****THE GRID ORIENTATION IN THE GRID LIST FILE',
     1            ' IS NEGATIVE.',/,5X,'THESE VALUES MUST',
     2            ' BE POSITIVE WEST.  STOP 110 IN CHKGRID2.')
         CALL W3TAGE('CHKGRID2')
         STOP 111
      ENDIF
C
