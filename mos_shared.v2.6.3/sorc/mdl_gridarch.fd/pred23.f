...
C   05-08-03  MALONEY ADDED NCEP DOCBLOCK. ADDED CALLS TO W3TAGE.
C                     CHANGED OPTION CALL TO OPTION_GRIDARCH
C   05-08-10  RLC     CHANGED CALL TO PACKGR_OPER TO SET ISCALE TO
C                     0.  I DON'T THINK THIS CALL IS USED, BUT JUST
C                     TO BE SAFE...
...
C        1         2         3         4         5         6         7 X
C 
C        SUBPROGRAMS CALLED:  GFETCH, OPTION_GRIDARCH, GRIDB, SMTH5, SMTH9, 
C            SMTH25, SMTH2X, SMTH3X, TRANS, BINARY, PREDX1, PACKV, 
C            PACKG, TIMPR, W3TAGE
C          UNIQUE: NONE
C          LIBRARY:
C           MOSLIB - GFETCH, OPTION_GRIDARCH, GRIDB, SMTH5, SMTH9, SMTH25, 
...
C
C ATTRIBUTES:
C   LANGUAGE:  FORTRAN 90 (xlf90 compiler) and ifort
...
C
 133  CALL OPTION_GRIDARCH(KFILDO,KFIL10,NFIRST,
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     +                       NDATE,NYR,NMO,NDA,NHR,
     3                       FD1,DATA,ND2X3,IS2(3),IS2(4),IPACK,IWORK,
     +                       ND5,
