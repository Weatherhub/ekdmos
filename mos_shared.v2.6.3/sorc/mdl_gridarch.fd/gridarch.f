...
C   00-12-01  GLAHN   
C   05-08-03  MALONEY ADDED NCEP DOCBLOCK. ADDED CALLS TO W3TAGB
C                     AND W3TAGE. CHANGED THE VALUE OF KFILDO FROM
C                     12 TO 6.  RENAMED MDL_GRIDARCH.
C   06-05-11  COSGROVE UPPED ND4
C   08-03-27  RLC     INCREASED ND2 AND ND3 TO COVER U155 AK GMOS
C                     GRID.
C 2010-01-22  MALONEY INCREASED MAXSTA TO 12000 FOR GMOS.
C 2010-03-29  FAN     INCREASED ND2 AND ND3 FOR 2.5KM CONUS GMOS.
C 2015-05-27  SDS     INCREASED ND3 FOR NORTHERN EXPANSION OF 2.5KM
C                     CONUS GRID.
C   
C        DATA SET USE
C        INPUT FILES:
...
C
     ...
     1     KFILDO/6/
      ...
      DATA LKHERE/ND6*1/
C
      CALL W3TAGB('MDL_GRIDARCH',2000,0258,0065,'W/OST22')
