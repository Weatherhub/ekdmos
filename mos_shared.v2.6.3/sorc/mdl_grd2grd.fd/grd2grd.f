...
C 2010-03-31  FAN        CHANGED ND2,ND3 TO HANDLE 2.5KM CONUS GMOS GRID.
C 2015-05-27  SCALLION   CHANGED ND3 TO COVER THE NORTHERN EXPANSION OF
C                        2.5KM CONUS GRI9D.
C
C        DATA SET USE
C        INPUT FILES:
