...
C$$$ 
     ...
     *            CCALL(MAXSTA,6)
      ...
      DATA KUNIT/12/,JUNIT/27/,IUNIT/10/,LUNIT/21/,LBULHD/11/,
     ...
     *     KFILDO/6/,KFILX/38/,IPTST/0/,KFILC/45/
      ...
      DATA MM/202140006,202240006,202140006,202240006,
     * 202140006,202240006,202140006,202240006,202140006,202240006,
     * 202140006,202240006,202140006,202240006,202140006/
      DATA MM12/202240006,202140006,202240006,202140006,202240006,
     * 202140006,202240006,202140006,202240006,202140006,
     * 202240006,202140006,202240006,202140006,202240006/
...
C
      ...
      INC=12
      DO 210 K=1,15
C       IF(K.GE.7)ID(1)=203320108
C       IF(K.GE.6)KD(1)=203320108
        ID(3)=ID(3)+INC
        CALL READ_MOSDA(KFILDO,KFILX,IPTST,ID,LDATE,CCALL,
     *       NMOSTA,FCST,MAXSTA,ND5,ND7,IS0,IS1,IS2,IS4,INDEX,IER)
        IF(IER.LT.2) KUT=KUT+1
...
C
      ...
      INC=12
      DO 230 K=1,12
        IF(K.GE.7) ID(1)=203331006
        IF(K.GE.6) KD(1)=203331006
        ID(3)=ID(3)+INC
        CALL READ_MOSDA(KFILDO,KFILX,IPTST,ID,LDATE,CCALL,
     *       NMOSTA,FCST,MAXSTA,ND5,ND7,IS0,IS1,IS2,IS4,INDEX,IER)
        IF(IER.LT.2) KUT=KUT+1
