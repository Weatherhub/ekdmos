...
C        OCTOBER 2005    MALONEY  REMOVED "EXIT" AFTER INCREMENT OF 
C                                 IFILCNT.  IF A STATION IS DUPLICATED
C                                 IN LIST( ) (QUITE LIKELY FOR THE RFC
C                                 BULLETINS) THIS WILL MAKE SURE EACH
C                                 ENTRY WILL GET THE PROPER LINKS.
C
C        PURPOSE
