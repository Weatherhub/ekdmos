...
C        BUILD 1ST LINE 
      ...
      CALL PUTCHAR('GFSX MOS GUIDANCE',MSG(9,(K-1)*LINE+2),17)
...
C
      ...
      INC=12
      DO 230 K=1,12
        IF(K.GE.7) ID(1)=203321008
        IF(K.GE.6) KD(1)=203321008
        ID(3)=ID(3)+INC
        CALL READ_MOSDA(KFILDO,KFILX,IPTST,ID,LDATE,CCALL,
     *       NMOSTA,FCST,MAXSTA,ND5,ND7,IS0,IS1,IS2,IS4,INDEX,IER)
        IF(IER.LT.2) KUT=KUT+1
