...
C            VALUES.
C
C            NOTE: (JULY 2012 ENGLE) THE USE OF EQUIVALENCE WITH
C                  THE CHARACTER TDLP AND INTEGER ITDLP IS THE REASON
C                  WHY WE MUST ALWAYS CALL BSWAP TO SWAP THE FIRST
C                  WORD OF IPACK( ).  THERE IS NO NEED TO BYTE SWAP
C                  THE LAST WORD IN IPACK( ) WHICH WOULD HOLD THE
C                  TDLPACK RECORD TERMINATOR OF '7777' SINCE ALL
C                  CHARACTERS ARE THE SAME.
C
C        DATA SET USE 
...
C           UNPKBG, UNPKLX, UNPKOO, UNPKPO, UNPKPS
C
      PARAMETER (NDG=65535)
C
      CHARACTER*4 C7777,TDLP,STATE
C
