...
C   MACHINE:  NAS                                                       
C
C   01-02     	SHIREY- CHANGED TO READ IN A 11 CHARACTER WMO HEADER
C               INSTEAD OF A 10 CHARACTER WMO HEADER.
C               NOW READS MOS 2000 SUB RDC
C                                                                       
C$$$                                                                    
...
C        WMO HEADER.                                                    
 ...
 20     FORMAT(A11)
        LEFT=MAXSTA-NSTA
        CALL RDC(6,0,NUNIT,CSTA(NSTA+1),LEFT,CTEMP,9,CFMT,NWMO(I),CTERM,
     *       ier)
        NSTA=NSTA+NWMO(I)
