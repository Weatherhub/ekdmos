      SUBROUTINE BSPEC(NSTA,KDATA,NVAL,SCALE,REF,ND1,NUMPRJ,LPROJ,
     *                 IVPRJ,NVPRJ)
...
C$$$ 
      IMPLICIT NONE
C 
      INTEGER NSTA,KDATA(ND1,NUMPRJ),NVAL,ND1,NUMPRJ,
     *        LPROJ(NUMPRJ),IVPRJ(NVPRJ),NVPRJ
      INTEGER IMULT,IREF,ITEMP,N,L,I
C
      REAL SCALE,REF
