...
C                                 IT.  THE SIZE IS 16*1280 = 20480 BYTES
C        COSGROVE  AUG 2005     - MODIFIED EXTENSIVELY TO SEND PRODUCTS
C                                 NTC RATHER THAN THROUGH THE STATFILE.
C                                 CHANGED FROM WRITING DIRECT ACCESS TO
C                                 USING NCEP ROUTINES TO OPEN AND WRITE
C                                 TO THE OUTPUT FILE.  CHANGED SOME
C                                 CHARACTER REPRESENTATIONS.  ADDED THE
C                                 FILE FIELD SEPARATOR.  THE WHOLE PART
C                                 ABOUT BEING A MULTIPLE OF LRECL IS NOW
C                                 JUST AN ARBITRARY BULLETIN SIZE.
...
C               LRECL=RECORD LENGTH (BYTES) OF TRANS FILE. 
...
C            BULLETIN.                                                  
C            NOTE:  IN AUGUST 2005 THIS ROUTINE WAS CHANGED.
...
C            WE'LL LEAVE IT AS IT IS...  1280 * 16 = 20480.   
C                                                                       
...
C       FIRST 19 BYTES OF THE ARRAY MT
