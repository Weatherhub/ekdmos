...
C   06-05-04  JCM     - INCREASED MAXSTA TO 25000 FOR GRIDDED MOS/CONUS
C   08-10-21  JCM     - CHANGED ETA MOS TO NAM MOS
C                                                                       
C           1         2         3         4         5         6
C1 1234567890123456789012345678901234567890123456789012345678901234567890
C2  44001  NAM MOS GUIDANCE    1/02/2003  0000 UTC
...
C                                                                       
C        DATA SET USE
C        READ(5...      - STANDARD INPUT /nwprod/parm/tdl_nammmetx.dat
...
C                 JUNIT=FILE NUMBER(5) USED TO ACCESS NAM STATION
C                       DIRECTORY FILE
...
C
      ...
      CALL W3TAGB('MDL_NAMMMETX',2002,0011,0066,'OST22')
      ND5=MAXSTA
