...
C           THE GRID FIELDS ARE INDEXED EAST TO WEST, THEN NORTH TO SOUT
...
C     GRIDX    - REAL (IMAX,JMAX,KMAX) GRID X-GRADIENTS (E->W,N->S) IF I
C     GRIDY    - REAL (IMAX,JMAX,KMAX) GRID Y-GRADIENTS (E->W,N->S) IF I
