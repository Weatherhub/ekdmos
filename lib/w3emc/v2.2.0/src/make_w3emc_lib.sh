...
for PRECISION in ${PRECISION_LIST}; do
  ...
  echo "==============================================================="
  echo
  echo ./configure --prefix=${PWD} --enable-promote=${PRECISION}
  ...
  if [ "${INSTALL_TYPE}" = "nco" ]; then
    ...
    case ${PRECISION} in
    4)
      export LIB=${W3EMC_LIB4:-../${COMP}/libw3emc_${W3EMC_VER}_4.a}
      export INC=${W3EMC_INC4:-../${COMP}/w3emc_${W3EMC_VER}_4}
    ;;
    8)
      export LIB=${W3EMC_LIB8:-../${COMP}/libw3emc_${W3EMC_VER}_8.a}
      export INC=${W3EMC_INC8:-../${COMP}/w3emc_${W3EMC_VER}_8}
    ;;
    d)
      export LIB=${W3EMC_LIBd:-../${COMP}/libw3emc_${W3EMC_VER}_d.a}
      export INC=${W3EMC_INCd:-../${COMP}/w3emc_${W3EMC_VER}_d}
    ;;
    esac
