...
#
export LIB=${W3NCO_LIB4:-../${COMP}/libw3nco_${BACIO_VER}_4.a}
mkdir -p $(dirname $LIB)
...
#
export LIB=${W3NCO_LIB8:-../${COMP}/libw3nco_${BACIO_VER}_8.a}
...
#     of libw3nco_d.a
#
export LIB=${W3NCO_LIBd:-../${COMP}/libw3nco_${BACIO_VER}_d.a}
