...
C                                 RATIOS OF INTERGERS NOT POWERS OF 2;
...
C                 XIN = ACTUAL MESH LENGTH CORRESPOINDING TO MESHIN.
C                       (INTERNAL)
C                XOUT = ACTUAL MESH LENGTH CORRESPOINDING TO MESHOUT.
C                       (INTERNAL)
C        1         2         3         4         5         6         7 X
C
...
D    4          4I7)
C
      IF(ND2X3.LT.NINT(XIN*XOUT))THEN
         NXNY=NXOUT*NYOUT
