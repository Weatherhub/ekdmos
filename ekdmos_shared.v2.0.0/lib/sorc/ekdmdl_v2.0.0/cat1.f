      SUBROUTINE CAT1(KFILDO,FCST,AVG,CORR,
...
C
C        PURPOSE
C           TO INFLAT FORECASTS FOR U700 AND U900.  IT IS ASSUMED 
...
C                       PREDICTAND TO INDICATE INFLATION = 1.  (INPUT)
C                 IER = STATUS RETURN.
C                         0 = GOOD RETURN.
C                       170 = ICAT DOES NOT EQUAL 1.
C                       (OUTPUT)
C 
...
C
 ...
 110     FORMAT(/,' ****ICAT =',I4,' DOES NOT EQUAL 1 IN ICAT1.',
     1            '  FORECASTS ARE NOT INFLATED.')
         IER=170
         GO TO 210
      ENDIF
C
