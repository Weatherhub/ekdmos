...
C 
D     WRITE(KFILDO,120)CFROM,KFILX,JREC,NWDS,KSIZE 
D120  FORMAT(' ENTER RDKEYM FROM'2XA6,'   KFILX ='I3,'  JREC ='I5,
D    1       '   NWDS ='I5,'   KSIZE ='I5) 
C
      IER=0 
C
      IF(JREC.LE.0.OR.
...
C
     ...
     1     NOPREC(3),NOPREC(5),NOPREC(6),(KEYREC(J),J=1,NEND)
      NREMIN=NREMIN-NEND
D     WRITE(KFILDO,129)NWDS,KSIZE,NREMIN,NEND
D129  FORMAT(/' AT 130 IN RDKEYM,NWDS,KSIZE,NREMIN,NEND'4I7)
...
C        AUGUST 28, 1998.
     ...
     1     (KEYREC(J),J=NSTART,NEND)
      NREMIN=NREMIN-KSIZE
D     WRITE(KFILDO,139)NWDS,KSIZE,NREMIN,NEND
D139  FORMAT(/' AT 140 IN RDKEYM,NWDS,KSIZE,NREMIN,NEND'4I7)
 140  CONTINUE
C      
 150  CONTINUE 
D     CALL TDLPRM(KFILDO,'RDKEYM  ')
D     WRITE(KFILDO,155)CFROM,NOPREC,KEYREC    
D155  FORMAT(' EXIT  RDKEYM FROM'2XA6,'   NOPREC ='6I5/
D    1       (1X6I10))
      GO TO 902 
C 
