...
C        FOR OPERATIONS, THE FILE= SPECIFIER IS OMITTED.
      OPEN(UNIT=FUNIT,FORM='UNFORMATTED',ACCESS='STREAM',
     1     IOSTAT=IOS,ERR=900,STATUS='OLD')
COPER
CDEV
C      OPEN(UNIT=FUNIT,FILE=FNAME,FORM='UNFORMATTED',
C     1     ACCESS='STREAM',STATUS='OLD')
CDEV
C
