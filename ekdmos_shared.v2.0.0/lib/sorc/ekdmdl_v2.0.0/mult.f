      SUBROUTINE MULT(KFILDO,X1,L1X1,L2X1,X2,L1X2,L2X2,X3,L1X3,L2X3,
     1                N1,N2,N3,IER)
C
...
C                                
C        PURPOSE
C           TO MULTIPLY TWO MATRICES X1 AND X2 TOGETHER AND FORM
C           PRODUCT IN X3.  THE DIMENSIONS OF THE ARRAYS OF
C           EACH MATRIX ARE FURNISHED ALONG WITH THE ACTUAL
C           MATRIX SIZES.
C
...
C             X2(J,K) = MULTIPLIER MATRIX (J=1,N2) (K=1,N3) IN ARRAY
C                       X1(L1X2,L2X2).  (INPUT)  (REAL*8)
C             X3(J,K) = PRODUCT MATRIX (J=1,N1) (K=1,N3) IN ARRAY
