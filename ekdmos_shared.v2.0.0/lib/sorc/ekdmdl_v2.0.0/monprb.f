...
C        JUNE      2005   RUDACK   ADDED IDS FOR CONDITIONAL VISIBILITY
C        JUNE      2005   WIEDENFELD ADDED IDS FOR WIND GUSTS.
C        JULY      2005   WIEDENFELD ADDED IDS FOR LAMP CEILING HGT
C                                  INCREASED NDIM TO 20. MODIFIED IF STATEMENT
C                                  NEAR DO 190 TO INCLUDE A CHECK FOR CEILING 
C                                  HGT ID FOR CUMULITIVE FROM BELOW.
