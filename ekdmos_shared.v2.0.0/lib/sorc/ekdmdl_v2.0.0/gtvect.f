...
C        MARCH     2004   GALHN   CHANGED CHECK ON 8XX TO 9XX BELOW 435
...
C
D     WRITE(KFILDO,405)N,(JD(J,N),J=1,4),(ID(J,N),J=1,4),NWHERE(N)
D405  FORMAT(' IN GTVECT, LOOKING FOR VRBL NO. ',
D    1       I3,3(1XI9.9),1XI10.3,3(1XI9.9),1XI10.3,'  NWHERE ='I4)
C
...
C***D409  FORMAT(' IN GTVECT, VRBL IN LD IS           ',
