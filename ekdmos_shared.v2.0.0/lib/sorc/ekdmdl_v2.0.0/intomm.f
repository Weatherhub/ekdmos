      SUBROUTINE INTOMM(KFILDO,KFIL10,IP12,KFILRA,RACESS,NUMRA,
     1                  ID,IDPARS,JD,ITAU,
...
C
C        PURPOSE 
C            TO CHANGE UNITS FROM INCHES TO MILLIMETERS.  CONVERSION USED:
C            1 INCH = 25.41 MM.  IDPARS(1) & IDPARS(2) OF PRECIPITATION  
...
C            XDATA(K) = VARIABLE IN INCHES, THEN IN MM (K=1,NSTA).
C                       (OUTPUT)
...
C
 ...
 107  FORMAT(' ****INTOMM ENTERED FOR VARIABLE',
     1         2X,I9.9,1X,I9.9,1X,I9.9,1X,I10.3,
     2       ' NOT ACCOMMODATED.')
      IER=102
      GO TO 300
C
C        GET THE PRECIPITATION IN INCHES
C
...
C
  ...
  125    FORMAT(' ****VARIABLE NOT RETRIEVED BY RETVEC IN INTOMM',
     1          2X,I9.9,1X,I9.9,1X,I9.9,1X,I10.3)
         GO TO 300
      ENDIF
C
