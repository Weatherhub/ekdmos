       SUBROUTINE IDSWAP(KFILDO,KFIL10,IP12,KFILRA,RACESS,NUMRA,
     1                  ID,IDPARS,JD,ITAU,
...
C 
C        SEPTEMBER 2000   RUDACK   TDL   MOS-2000
C
C        PURPOSE 
C            TO REPLACE IDPARS(1) AND IDPARS(2) WITH NEW ID VALUES.  
C
C            (1) & IDPARS(2)
...
C  
      DATA LDPARS/15*0/
      DATA ITABLE/208900,2086453,208,900/
C
      IER=0
      ISTAB=1
C     
...
C     
 ...
 107  FORMAT(/,' ****IDSWAP ENTERED FOR VARIABLE',
...
C
 ...
 110     FORMAT(/,' ****NCAT =',I4,' NOT CORRECT IN IDSWAP.')
         IER=102
         GO TO 300
      ENDIF
C     
      IDPARS(1,1)=ITABLE(3,1)
      IDPARS(2,1)=ITABLE(4,1)
C
 300  RETURN
      END     
