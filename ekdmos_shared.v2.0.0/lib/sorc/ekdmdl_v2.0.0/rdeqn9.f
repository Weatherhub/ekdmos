      SUBROUTINE RDEQN9(KFILDO,KFILEQ,EQNNAM,NDATE,
...
C                                 CHNAGED 30I4 TO 20I6 IN FORMAT 223;
C                                 INITIALIZED LOCSTA( ); COMMENTS;
C                                 MODIFIED TO NOT START AT THE BEGINNING
C                                 OF THE LOOP IN SEARCHING; OMITTED KEEP
C                                 AND THE ASSOCIATED DIAGNOSTIC BECAUSE
C                                 IT DOES NOT WORK IN THIS OPERATIONAL
C                                 VERSION; NOTE:  RDEQN9 IS USED FOR
C                                 U900, RDEQN FOR U700
C        NOVEMBER  2001   MCE     TOOK OUT CALLS TO TIMPR; THE PRINTS
C                                 FROM THIS FOR HUNDREDS OF CALLS IN 
C                                 OPERATIONS ARE UNNEEDED. ADDED IF TEST
C                                 FOR LINKS 2 THROUGH 6.
C
C        PURPOSE
...
C                         IN RDEQN9 AND IS COMPOSED OF ALL STATIONS IN 
...
C
 ...
 1130    FORMAT(/,' ****NUMBER OF PREDICTANDS =',I4,' GT ND3 =',I4,
     1            ' AT 1130 IN RDEQN9 FOR FILE ',A60,/,
     2            '     READING OF EQUATIONS ABORTED.')
         IER=166
         GO TO 950
C
...
C
 ...
 1225       FORMAT(/,' ****NUMBER OF STATIONS TO MAKE FORECASTS',
     ...
     2               ' AT 1225 IN RDEQN9.',/,'     ON FILE ',A60,/,
...
C
 ...
 1226       FORMAT(/,' ****NUMBER OF GROUPS TO MAKE FORECASTS',
     1               ' FOR EXCEEDS ND13 =',I6,' AT 1226 IN RDEQN9.',/,
     2               '     ON FILE ',A60,/,
     3               '     READING OF EQUATIONS ABORTED.')
            KGP=KGP-1
            IER=169
...
C           LINK BEFORE PROCEEDING TO SECOND, ETC.  RDEQN9
...
C*** 1228    FORMAT(' IN RDEQN9 AT 1228,K,MM,L,CCALLD(K),CCALL(L,MM),',
...
C
 ...
 1229          FORMAT(/,' ****NUMBER OF STATIONS TO MAKE FORECASTS',
     1                  ' FOR EXCEEDS ND1 =',I6,' AT 1229 IN RDEQN9.',/,
     2                  '     ON FILE ',A60,/,
     3                  '     READING OF EQUATIONS ABORTED.')
               IER=169
               GO TO 950
...
C
 ...
 126        FORMAT(/,' ****READING ABORTED AT 126 IN RDEQN9,',
     1              ' FOR FILE ',A60)
            GO TO 800
         ENDIF
C
...
C
 ...
 130        FORMAT(/,' ****NUMBER OF STATIONS TO MAKE FORECASTS',
     1               ' FOR EXCEEDS ND1 =',I6,' AT 130 IN RDEQN9.',/,
     2               '     FOR FILE ',A60,/,
     3               '     READING OF EQUATIONS ABORTED.')
            IER=169
            GO TO 950
...
C
 ...
 135     FORMAT(/,' ****ZERO TERMS INDICATED FOR NEXT EQUATION',
     1            ' AT 135 IN RDEQN9 ON FILE ',A60,/,
     2            '     READING OF EQUATIONS ABORTED.')
         IER=167
         GO TO 950
      ENDIF
C
 ...
 1350    FORMAT(/,' ****NUMBER OF TERMS INDICATED FOR NEXT',
     ...
     2            '     AT 1350 IN RDEQN9 ON FILE ',A60,/,
     3            '     READING OF EQUATIONS ABORTED.')
         IER=167
         GO TO 950
      ENDIF
...
C***D182     FORMAT(' IN RDEQN9 AT 182',4I10)
      ENDIF
C
      GO TO 121
C
...
C        IER1 COMES FROM RDC.
      GO TO 950
C
 900  CALL IERX(KFILDO,KFILDO,IOS,'RDEQN9',STATE)
      IER=168
C
 950  CONTINUE      
C
