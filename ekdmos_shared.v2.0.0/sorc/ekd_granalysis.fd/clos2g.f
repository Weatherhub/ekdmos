...
C           THIS IX,JY IS OUTSIDE THE CLIPPING AREA.
         IF(NEARSV(IX,JY).EQ.999999)GO TO 209
...
C           THIS IX,JY IS OUTSIDE THE CLIPPING AREA.
         IF(NEARSV(IX,JY).EQ.999999)GO TO 219
C           THE NEAREST STATION COULD NOT BE FOUND.
C
         IF(L.EQ.1.AND.SEALND(IX,JY).GT.8.5.OR.
     1      L.EQ.2.AND.SEALND(IX,JY).LT.8.5)THEN
...
C           THIS IX,JY IS OUTSIDE THE CLIPPING AREA.
         IF(NEARSV(IX,JY).EQ.999999)GO TO 229
C           THE NEAREST STATION COULD NOT BE FOUND.
C
         IF(L.EQ.1.AND.SEALND(IX,JY).GT.8.5.OR.
     1      L.EQ.2.AND.SEALND(IX,JY).LT.8.5)THEN
...
C           THIS IX,JY IS OUTSIDE THE CLIPPING AREA.
         IF(NEARSV(IX,JY).EQ.999999)GO TO 239
C           THE NEAREST STATION COULD NOT BE FOUND.
C
         IF(L.EQ.1.AND.SEALND(IX,JY).GT.8.5.OR.
     1      L.EQ.2.AND.SEALND(IX,JY).LT.8.5)THEN
...
C           THIS IX,JY IS OUTSIDE THE CLIPPING AREA.
         IF(NEARSV(IX,JY).EQ.999999)GO TO 249
C           THE NEAREST STATION COULD NOT BE FOUND.
C
         IF(L.EQ.1.AND.SEALND(IX,JY).GT.8.5.OR.
     1      L.EQ.2.AND.SEALND(IX,JY).LT.8.5)THEN
