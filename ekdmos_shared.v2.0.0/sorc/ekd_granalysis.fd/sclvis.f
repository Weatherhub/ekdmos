...
C            WAS WRITTEN FOR VISIBILITY, AND ITABLE( , ) IS
...
D114  FORMAT(/,' IN SCLVIS AT 114',/,(8(I7,F8.2)))
C
C        SET FD2( ) = 9999.
C
      DO 115 K=1,NVAL
...
C           OF THE UPPER CATEGORY, NCAT=7, IS UNITY MINUS THE 
...
D1495    FORMAT(' IN SCLVIS AT 1495--XDATA(K),DATA(K),XMAX,XMIN',
...
D160  FORMAT(/,' IN SCLVIS AT 160--XMAX,XMIN,RANGE,A,B',
D    1         5F10.3)
C
      XMAXJ=J+.99
...
D225  FORMAT(/,' IN SCLVIS AT 225',/,(8(I7,F8.2)))
C
 900  RETURN
      END
