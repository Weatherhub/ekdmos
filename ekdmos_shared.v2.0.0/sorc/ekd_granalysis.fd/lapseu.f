...
C        JANUARY   2009   WAGNER  ALTERED FOR EKDMOS
C
C        PURPOSE
...
C
      DO 102 L=1,NDIM
C
C        20090109 ALTERED FOR EKDMOS
C      IF(ID(1)/100.EQ.ITABLE(1,L)/100.AND.
C     1   ID(2).EQ.ITABLE(2,L))GO TO 104
      IF(ID(1)/100.EQ.ITABLE(1,L)/100)GO TO 104
...
C
C        20090109 ALTERED FOR EKDMOS
C      LD(1)=ITABLE(3,L)+IDPARS(4)
       IF(IDPARS(4).NE.61)THEN
