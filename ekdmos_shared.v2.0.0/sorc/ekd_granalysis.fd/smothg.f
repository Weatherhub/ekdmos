...
C        AUGUST    2009   GLAHN   REMOVED DIFF FROM COMMENTS; ADDED
C                                 COMMENT ABOUT MESH LENGTH
C
C        PURPOSE
...
C
C            THE SMOOTHER WAS EXTENSIVELY TESTED ON A 5-KM GRID OVER
C            THE CONUS.  IT APPEARS IT DOES NOT NEED TO BE ADJUSTED
C            FOR 2.5 KM.  THAT IS, DIFFA DOES NOT NEED TO BE CHANGED.
C            MORE POINTS WILL BE SMOOTHED WITH THE SYMMETRIC 9- OR
C            5-POINT STENCIL THAN WITH 5 KM; THAT IS PROBABLY OK. 
C            THE "AREA" BEING SMOOTHED WITH THE SAME STENCIL IS 
C            SMALLER, COMMENSURATE WITH THE SMALLER GRID SPACING.
C            THIS WILL MAKE FEWER "DIRECTIONAL" SMOOTHINGS.
C
C        DATA SET USE
...
C
            ENDIF
C
C           CHECK FOR LOW ELEVATION CENTER.
C                
